...
// Event listener for the form submit event in the Sales Omzet form
document.getElementById('salesInputForm').addEventListener('submit', function (event) {
    ...
    // Use the fetch function to send a POST request to SalesOmzetInputJoost.php with the 'omzet' value in the body
